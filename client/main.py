...
con = psycopg2.connect(database="foofle", user="postgres", password="", host="127.0.0.1", port="5432")
cur = con.cursor()
...
while True:
    if state == 1:  # welcome menu
        ...
        print('Please enter the following information:')
        print('Write \'cc:\' in the beginning if you want to cc an email address (cc:example@foofle.com)')
        all_recipients = []
        while True:
